...
print ('The percent difference of W is:', perc_mean_error_W*100,'(mean)',perc_std_error_W,'(std)','%')
print ('The percent difference of W is:', perc_mean_error_b*100,'(mean)',perc_std_error_b,'(std)','%')