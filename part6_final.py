...
w1_c = 28*(28/2  + int(round(6*np.random.rand())) - 3) + 28/2  + int(round(6*np.random.rand())) - 3
w2_c = 28*(28/2  + int(round(6*np.random.rand())) - 3) + 28/2  + int(round(6*np.random.rand())) - 3
w1_r = int(round((10-1)*np.random.rand()))
w2_r = int(round((10-1)*np.random.rand()))
